...
<ul>
<li>Modify the way in which SMPTE metadata is transported.</li>
<li>Update the version advertised in PTP message headers.</li>
<li>Accommodate the new PTP sdoid field.</li>
<li>Update which options are permitted.  There are two specific options about which user feedback is requested below.</li>
<li>Editorial changes such as removing some residual support for peer-to-peer mode.</li>
</ul>
...
<ul>
<li>Follower event monitoring as described in IEEE-1588:2019 subclause 16.11.</li>
<li>PTP integrated security mechanism as described in IEEE-1588:2019 subclause 16.14.</li>
</ul>
